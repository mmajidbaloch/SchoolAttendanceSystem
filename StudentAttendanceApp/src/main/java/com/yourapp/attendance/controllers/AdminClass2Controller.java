...
public class AdminClass2Controller {

    @FXML private Label teacherNameWithClassId102;
    @FXML private ChoiceBox<String> assignAttendenceTakerTeacherC102;
    @FXML private Button updateStudentAttendenceRecordC102;
    @FXML private TableColumn<Student, String> takenByTeacherClass102;
    @FXML private TableColumn<Student, Integer> calculateStudentPresentDaysC102;
    @FXML private TableColumn<Student, Integer> calculateStudentAbsentDaysC102;


    @FXML private TableView<?> fetchStudentsTable;
    @FXML private TableView<Student> class2TableView;
    @FXML private TableColumn<Student, Integer> fetchStudentIdClassIdIs102;
    @FXML private TableColumn<Student, String> fetchStudFNameClassIdIs102;
    @FXML private TableColumn<Student, String> fetchStudLNameClassIdIs102;
    @FXML private TableColumn<Student, String> fetchStudGenderClassIdIs102;

    private ObservableList<Student> studentList102 = FXCollections.observableArrayList();
    private Map<String, AttendanceInfo> attendanceMap = new HashMap<>();


    private final String CLASS_ID = "102";
    ...
    private void loadAssignedTeacher() {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            if (rs.next()) {
                ...
                teacherNameWithClassId102.setText("Assigned Teacher: " + username);
            } else {
                teacherNameWithClassId102.setText("Assigned Teacher: None");
            }

        } catch (SQLException e) {
            teacherNameWithClassId102.setText("Error loading teacher");
            e.printStackTrace();
        }
    }

    private void loadAttendanceDataForClass2() {
    ...
    private void loadClass2Students() {
        String query = "SELECT student_id, first_name, last_name, father_name, class_name, class_id, gender, enrolled_year, username, password FROM students WHERE class_id = '102'";
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            fetchStudentIdClassIdIs102.setCellValueFactory(new PropertyValueFactory<>("studentId"));
            fetchStudFNameClassIdIs102.setCellValueFactory(new PropertyValueFactory<>("firstName"));
            fetchStudLNameClassIdIs102.setCellValueFactory(new PropertyValueFactory<>("lastName"));
            fetchStudGenderClassIdIs102.setCellValueFactory(new PropertyValueFactory<>("gender"));

            class2TableView.setItems(studentList102);
            takenByTeacherClass102.setCellValueFactory(cellData ->
            ...
            calculateStudentPresentDaysC102.setCellValueFactory(cellData ->
                    new ReadOnlyObjectWrapper<>(attendanceMap.getOrDefault(cellData.getValue().getStudentId(), new AttendanceInfo(0, 0, "")).presentDays));

            calculateStudentAbsentDaysC102.setCellValueFactory(cellData ->
    ...
    private void loadTeacherOptions() {
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            assignAttendenceTakerTeacherC102.setItems(usernames);
    ...
    private void updateTeacherAssignment() {
        String selectedUsername = assignAttendenceTakerTeacherC102.getValue();
        ...
        try (Connection conn = DatabaseConnection.getConnection()) {
            ...
            if (rs.next()) {
                ...
                teacherNameWithClassId102.setText("Assigned Teacher: " + selectedUsername);
